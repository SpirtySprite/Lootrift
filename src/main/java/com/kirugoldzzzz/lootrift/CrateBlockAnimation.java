...
public enum CrateBlockAnimation {
    ...
    AUCUNE("aucune", Tr.t("Aucune"), Material.BARRIER,
            Tr.t("Aucune particule autour de la caisse.")),
    HALO("halo", Tr.t("Halo"), Material.END_ROD,
            Tr.t("Un anneau qui tourne au-dessus du bloc.")),
    ANNEAU_DOUBLE("anneau-double", Tr.t("Double anneau"), Material.ENDER_EYE,
            Tr.t("Deux anneaux tournant en sens inverse.")),
    SPIRALE("spirale", Tr.t("Spirale"), Material.STRING,
            Tr.t("Une hélice qui monte le long du bloc.")),
    DOUBLE_HELICE("double-helice", Tr.t("Double hélice"), Material.IRON_BARS,
            Tr.t("Deux hélices entrelacées, façon ADN.")),
    VORTEX("vortex", Tr.t("Vortex"), Material.ENDER_PEARL,
            Tr.t("Une spirale qui se resserre en montant.")),
    TORNADE("tornade", Tr.t("Tornade"), Material.WHITE_WOOL,
            Tr.t("Un cône qui s'élargit vers le haut.")),
    FONTAINE("fontaine", Tr.t("Fontaine"), Material.WATER_BUCKET,
            Tr.t("Un jet qui retombe en cloche.")),
    COLONNE("colonne", Tr.t("Colonne"), Material.BEACON,
            Tr.t("Un faisceau vertical au centre du bloc.")),
    ORBITE("orbite", Tr.t("Orbite"), Material.ENDER_EYE,
            Tr.t("Quelques points en orbite inclinée.")),
    SPHERE("sphere", Tr.t("Sphère"), Material.SLIME_BALL,
            Tr.t("Une coquille sphérique scintillante.")),
    CUBE("cube", Tr.t("Cube"), Material.GLASS,
            Tr.t("Les douze arêtes d'un cube en rotation.")),
    COURONNE("couronne", Tr.t("Couronne"), Material.GOLDEN_HELMET,
            Tr.t("Un anneau hérissé de pointes.")),
    ETOILE("etoile", Tr.t("Étoile"), Material.NETHER_STAR,
            Tr.t("Une étoile à cinq branches qui tourne.")),
    PULSATION("pulsation", Tr.t("Pulsation"), Material.HEART_OF_THE_SEA,
            Tr.t("Un anneau qui enfle et se rétracte.")),
    ONDE("onde", Tr.t("Onde"), Material.PRISMARINE_SHARD,
            Tr.t("Des vagues concentriques qui s'éloignent.")),
    PAPILLON("papillon", Tr.t("Papillon"), Material.PINK_PETALS,
            Tr.t("Une courbe de Lissajous en huit.")),
    PLUIE("pluie", Tr.t("Pluie"), Material.BLUE_ICE,
            Tr.t("Des particules qui tombent autour du bloc.")),
    TOURBILLON("tourbillon", Tr.t("Tourbillon"), Material.SOUL_SAND,
            Tr.t("Un remous plaqué au sol.")),
    ASCENSION("ascension", Tr.t("Ascension"), Material.FEATHER,
            Tr.t("Des points qui montent en colonnes décalées.")),
    ATOME("atome", Tr.t("Atome"), Material.AMETHYST_SHARD,
            Tr.t("Trois anneaux inclinés comme des orbitales.")),
    GALAXIE("galaxie", Tr.t("Galaxie"), Material.NETHER_STAR,
            Tr.t("Deux bras spiraux qui tournent à plat.")),
    DOME("dome", Tr.t("Dôme"), Material.TURTLE_HELMET,
            Tr.t("Une demi sphère posée sur le bloc.")),
    CROIX("croix", Tr.t("Croix"), Material.NETHERITE_SWORD,
            Tr.t("Quatre branches qui pivotent.")),
    LOSANGE("losange", Tr.t("Losange"), Material.DIAMOND,
            Tr.t("Un losange vertical en rotation.")),
    SABLIER("sablier", Tr.t("Sablier"), Material.SAND,
            Tr.t("Deux cônes opposés qui se rejoignent.")),
    SATURNE("saturne", Tr.t("Saturne"), Material.ENDER_EYE,
            Tr.t("Une sphère ceinte d'un anneau plat.")),
    SERPENTIN("serpentin", Tr.t("Serpentin"), Material.LEAD,
            Tr.t("Une hélice qui ondule en montant.")),
    BATTEMENT("battement", Tr.t("Battement"), Material.REDSTONE,
            Tr.t("Deux pulsations rapprochées, comme un cœur.")),
    COMETE("comete", Tr.t("Comète"), Material.FIRE_CHARGE,
            Tr.t("Un point rapide qui laisse une traînée."));
